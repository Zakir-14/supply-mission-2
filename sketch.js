...
function setup() {
	...
	packageBody = Bodies.rectangle(	335, 200 , 10,10 , {restitution:0.5, isStatic:true});
	//Matter.Body.setVelocity(packageBody,{x:4,y:0})
	World.add(world, packageBody);
	
	box1 = Bodies.rectangle(330,655,150,50,{isStatic:true})
